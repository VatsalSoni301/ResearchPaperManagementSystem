...
def admin_archived():
		...
		if 'id' not in session:
			...
			arrx=notify(arrx)
			count=noticount()
			return render_template("admin_archived_paper.html",name="Archived Paper",arr=arr,arr1=arr1,img=img,fname=fname,c=count,arr2=arrx)	
...
def volume():
		...
		if 'id' not in session:
			...
			arrx=notify(arrx)
			count=noticount()
			return render_template("admin_add_volume.html",name="Volume",arr=arr,arr1=arr1,img=img,fname=fname,arr2=arrx,c=count)	
...
def issue():
		...
		if 'id' not in session:
			...
			return render_template("admin_add_issue.html",name="Issue",arr=arr,img=img,arr1=arr1,fname=fname,arr2=arrx,c=count)	
