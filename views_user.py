...
def announcements():
		...
		if 'id' not in session:
			...
			arrx=notify_user(arrx)
			count=noticount_user()
			return render_template("user_announcement.html",name="Announcement",arr=arr,fname=fname,img=img,arr1=arrx,c=count)
...
def browse():
		...
		if 'id' not in session:
			...
			arrx=notify_user(arrx)
			count=noticount_user()
			return render_template("user_browse.html",name="Browse",img=img,arr=arr,arr1=arr1,arr2=arr2,arr3=arr3,fname=fname,arr4=arrx,c=count)	
